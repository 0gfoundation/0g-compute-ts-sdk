...
export declare class InferenceBroker {
     ...
     */
    listService: (offset?: number, limit?: number, includeUnacknowledged?: boolean) => Promise<import("../contract").ServiceStructOutput[]>;
    /**
     ...
     * ```
     */
    listServiceWithDetail: (offset?: number, limit?: number, includeUnacknowledged?: boolean) => Promise<import("./model").ServiceWithDetail[]>;
    /**
