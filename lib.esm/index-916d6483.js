...
function requirePrivateKey () {
	...
	var utils_1 = /*@__PURE__*/ requireUtils$3();
	var index_js_1 = requireUtils();
	var PublicKey_js_1 = requirePublicKey();
...
function requireKeys () {
	...
	(function (exports) {
		...
		var PrivateKey_js_1 = requirePrivateKey();
...
function requireDist () {
	...
	(function (exports) {
		...
		var utils_1 = /*@__PURE__*/ requireUtils$3();
		var config_js_1 = requireConfig();
		var index_js_1 = requireKeys();
		var index_js_2 = requireUtils();
		/**
...
async function initNodeModules() {
    ...
    if (!fs) {
        ...
        AdmZip = (await import('./adm-zip-1c4c257b.js').then(function (n) { return n.a; })).default;
...
async function safeDynamicImport() {
    ...
    const { download } = await import('./index-dbe9f00b.js');
    return { download };
}
...
class Provider {
    ...
    async uploadDatasetToTEE(providerAddress, datasetPath, options) {
        try {
            ...
            const FormData = (await import('./browser-f194dfc5.js').then(function (n) { return n.b; })).default;
...
//# sourceMappingURL=index-916d6483.js.map
